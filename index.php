        ...
        <header class="slider">
            <div class="swiper-container gallery-top">
                <div class="swiper-wrapper">
                    <div class="swiper-slide" data-background="images/carrossel/Banner_Carrossel_Home_01.jpg"></div>
                    <div class="swiper-slide" data-background="images/carrossel/Banner_Carrossel_Home_02.jpg"></div>
                    <div class="swiper-slide" data-background="images/carrossel/Banner_Carrossel_Home_03.jpg"></div>
                </div>
                <!-- end swiper-wrapper -->
            ...
            <ul>
                <li>
                    <figure class="reveal-effect masker wow">
                        <a href="case-single.php"><img src="images/Site_01_780x1000_02.jpg" alt="Image" /></a>
                    </figure>
                ...
                <li>
                    <figure class="reveal-effect masker wow">
                        <a href="images/works02.jpg" data-fancybox><img src="images/works02.jpg" alt="Image" /></a>
                    </figure>
                    <div class="caption wow" data-splitting>
                ...
                <li>
                    <figure class="reveal-effect masker wow">
                        <a href="images/works03.jpg" data-fancybox><img src="images/works03.jpg" alt="Image" /></a>
                    </figure>
                    <div class="caption wow" data-splitting>
                        <h3>Hard Employee</h3>

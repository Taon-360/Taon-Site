...
<html lang="en">
  <head>
    ...
    <style>
      ...
      #section10 a span {
        ...
        -webkit-box-shadow: -1px 3px 32px 1px rgba(0, 0, 0, 0.73);
        box-shadow: -1px 3px 32px 1px rgba(0, 0, 0, 0.73);
      }
  ...
  <body>
    ...
    <script>
      ...
      var canvasFront = document.getElementById("IcanvasFront");
      ...
      function update() {
        ...
        if (splatStack.length > 0) {
          for (var m = 0; m < splatStack.pop(); m++) {
            var array = [
              [0.9568627450980393, 0.5058823529411764, 0.12156862745098039],
              [1, 0.8666666666666667, 0],
              [0.6313725490196078, 0.807843137254902, 0.3803921568627451],
              [0, 0.6509803921568628, 0.611764705882353],
              [0, 0.5294117647058824, 0.8117647058823529],
              [0.12941176470588237, 0.24313725490196078, 0.6],
              [0.49411764705882355, 0.24313725490196078, 0.5882352941176471],
              [0.3686274509803922, 0.1803921568627451, 0.49019607843137253],
            ];
            var color = array[Math.floor(Math.random() * 8)];
            // var color = [
            //   Math.random() * 10,
            //   Math.random() * 10,
            //   Math.random() * 10,
      ...
      canvasFront.addEventListener("mousemove", function (e) {
        count++;
        var array = [
          [0.9568627450980393, 0.5058823529411764, 0.12156862745098039],
          [1, 0.8666666666666667, 0],
        ...
        count > 25 &&
          ((colorArr = [
            array[position][0] + 0.2,
            array[position][1] + 0.2,
            array[position][2] + 0.2,
          ]),
          (count = 0));
